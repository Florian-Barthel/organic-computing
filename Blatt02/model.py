...
class AntModel(Model):
    ...
    def __init__(self, num_ants, particle_density, step_size, all_in_center, grid_width, grid_height):
        super().__init__()
        ...
        self.datacollector = DataCollector(
            model_reporters={"Particles with neighbors percentage": get_num_particles_with_neighbors_percent,
        ...
        self.start_entropy_particle_type = entropies.entropy_particle_type(self)
